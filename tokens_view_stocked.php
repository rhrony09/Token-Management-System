...
$sql = "SELECT * FROM token WHERE status = 'Stocked' UNION SELECT * FROM token WHERE status = 'Returned' ORDER BY id desc";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Total Stocked (<?= $query->num_rows ?>)</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Total Stocked</li>
                </ol>
            </section>
